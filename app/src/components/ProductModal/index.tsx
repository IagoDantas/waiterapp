...
export function ProductModal({ visible, onClose, product, onAddToCart }: IProductModalProps) {

  if (!product) return null;


  function handleAddToCart() {
    onAddToCart(product!);//essa exclamação é para dizer que o product não é nulo
    onClose();
  }
  return (
    <Modal
